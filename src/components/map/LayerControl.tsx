    ...
    <div className={clsx('glass-strong rounded-xl p-3 border border-flood-border flex flex-col gap-3', className)}>
      <div className="flex items-center gap-2">
        <Tooltip content="Zoom in">
          <button onClick={onZoomIn} className="btn-ghost p-2" aria-label="Zoom in">+</button>
        </Tooltip>
        <Tooltip content="Zoom out">
          <button onClick={onZoomOut} className="btn-ghost p-2" aria-label="Zoom out">−</button>
        </Tooltip>
        <div className="w-px h-8 bg-flood-border mx-1" />
        <Tooltip content="Locate me">
          <button onClick={onLocate} className="btn-ghost p-2" aria-label="Locate me">
        ...
        <Tooltip content="Fullscreen">
          <button onClick={onFullscreen} className="btn-ghost p-2 ml-auto" aria-label="Fullscreen">
