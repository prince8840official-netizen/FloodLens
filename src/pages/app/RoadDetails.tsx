...
export function RoadDetails() {
  ...
  const { roads, drains, incidents, cameras, onRoadClick, activeMapLayers, mapCenter, mapZoom, onMapClick } = useApp();
